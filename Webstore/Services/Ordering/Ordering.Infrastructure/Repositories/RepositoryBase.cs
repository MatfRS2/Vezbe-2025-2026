...
public class RepositoryBase<T> : IAsyncRepository<T> where T : AggregateRoot
{
    ...
    public Task<IReadOnlyList<T>> GetAsync(Func<T, bool> predicate, List<Expression<Func<T, object>>> includes, Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy = null, bool disableTracking = true)
    {
